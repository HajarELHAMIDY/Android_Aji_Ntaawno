...
public class PublierDemandeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
        ...
        View root = inflater.inflate(R.layout.fragment_publierdemande, container, false);
        ((AppCompatActivity) getContext()).getSupportActionBar().setTitle("Publier une nouvelle demande");
        ...
        newPostImage=root.findViewById(R.id.DemandeImagePost);
        newPostDesc=root.findViewById(R.id.DemandeDescription);
        newPostBtn=root.findViewById(R.id.DemandeModifier);
        newPostProgress=root.findViewById(R.id.DemandeProgress);
        newPostTitre=root.findViewById(R.id.Demandetitre);
        newPostNPiece=root.findViewById(R.id.Demandenombrepiece);
        spinnerCategorie = (Spinner)root.findViewById(R.id.DemandeCategorie);
        spinnerVille= (Spinner)root.findViewById(R.id.DemandeVille);
                        ...
                        filePath.putFile(postImageUri).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                            ...
                            public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                                ...
                                if(task.isSuccessful()){
                                    ...
                                    postMap.put("Image_Demande", downloadUri);
                                    postMap.put("Description",desc);
                                    postMap.put("User_id",current_id);
                                    postMap.put("TimePub",time);
                                    postMap.put("TitreDemande",titre);
                                    postMap.put("NombrePiece",nombrepiece);
                                    postMap.put("Reservation","non");
                                    postMap.put("Categorie",categorie);
                                    postMap.put("Ville",ville);

                                    firebaseFirestore.collection("Demandes").add(postMap).addOnCompleteListener(new OnCompleteListener<DocumentReference>() {
                                        @Override
                                        public void onComplete(@NonNull Task<DocumentReference> task) {
                                            if(task.isSuccessful()){

                                                Toast.makeText(getContext(),"Demande Publiée",Toast.LENGTH_LONG).show();
